    ...
    <div class="wrapper">
      ...
      <main>
        ...
        <section class="content index">
          ...
          <p class="first">I am a Full Stack Developer working to advance the progressive political movement in the United States.  My principal skills include React, Redux, React Native and Firebase.  Before becoming a web developer, I taught college Spanish for almost twenty years. My experience in the humanities lends me a unique insight into the tech world (see the link in the "Related" section).</p>
