    ...
    <div class="wrapper">
      ...
      <main>
        ...
        <section class="content index">
          <h2>Full Stack Developer | Left-Wing Activist</h2>
          <div class="image">
          ...
          <p>In addition to being a web developer, I am a left-wing activist.  In the course of the presidential campaign of 2016, I became a part of the movement that sprang up around the candidacy of Senator Bernie Sanders, volunteering to make phone calls to voters and engaging with fellow volunteers. After the election, I remained politically active, volunteering for progressive organizations such as Justice Democrats. Currently, I am doing volunteer work for Senator Sanders' 2020 campaign as a web developer.  The team I work on, Coders For Bernie Sanders, has created an AirB&B-style application for campaign staff and volunteers, called BernieBnB, currently available for download in the App and Google Play stores (see the link in the "Related" section).</p>
