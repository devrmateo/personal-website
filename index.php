    ...
    <div class="wrapper">
      ...
      <main>
        ...
        <section class="content index">
          ...
          <p class="first">I am a Full Stack Developer in service of the progressive political movement in the United States.  My principal skills include React, Redux, React Native and Firebase.  Before becoming a web developer, I taught college Spanish for almost twenty years. My experience in the humanities lends me a unique insight into the tech world (see the link in the "Related" section).</p>
          ...
          <p>As I was completing my career change, I was also becoming more engaged politically.  In 2016, I became a part of the movement that sprang up around the presidential candidacy of Senator Bernie Sanders, volunteering to make phone calls to voters and engaging with fellow campaign volunteers. After the election, I remained politically active, volunteering for organizations such as Justice Democrats. Currently, I am volunteering for Sanders' 2020 bid as both a web developer and a Spanish call team volunteer.  The development team I currently work on, Coders For Bernie Sanders, has created an AirB&B-style application for Sanders' campaign staffers and volunteers called BernieBnB. The app is available for download in the App and Google Play stores (see the link in the "Related" section).</p>
        </section>
