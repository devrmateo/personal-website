...
<html>
  <head>
    ...
    <title>Matthew Price Smith | Resume</title>
  </head>
  <body>
    <div class="wrapper">
        ...
        <section class="content extendedContent">
          ...
          <section class="tech">
            ...
            <section class="certifications">
              ...
              <ul class="duties">
                <li class="description">Performed all website development and provided assistance to faculty and graduate-student users.</li>
                <li class="description">Supported a department of thirty faculty users and sixty-plus graduate students.</li>
                <li class="link"><a class="url" href="http://spanish.arizona.edu/" target="_blank">http://spanish.arizona.edu/</a></li>
              </ul>
            </section>
          </section>
          <section class="tech">
            ...
            <section class="certifications">
              ...
              <span class="institution">Department of Spanish and Portuguese, The University of Arizona</span>
              <ul class="duties">
                <li class="description">Collaborated with D2L Support Team to facilitate online instruction for graduate-student teachers.</li>
                <li class="description">Gave presentations and created online tutorials for a cohort of sixty-plus instructors.</li>
                <li class="link"><a class="url" href="https://d2l.arizona.edu/d2l/loginh/" target="_blank">https://d2l.arizona.edu/d2l/loginh/</a></li>
              </ul>
            </section>
          </section>
          ...
          <section class="academic">
            ...
            <section class="degreeInst">
              <div>
                ...
                <span class="institution">Udemy</span>
              </div>
            </section>
          </section>
          <section class="academic">
